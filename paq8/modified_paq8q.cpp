/*  paq8q file compressor/archiver.  Release by Simon Berger May. 13, 2009
...
void sparseTextModel( Mixer &m ) {
  ...
  if( bpos == 0 ) {
    int fl = 0;
    if( ( ( ( c4
              & static_cast<unsigned int>( ( static_cast<unsigned int>( static_cast<unsigned int>( 0xff ) != 0 ) )
                                           != 0U ) ) ) )
        != 0U ) {
      if( isalpha( c4 & 0xff ) != 0 )
        ...
        fl = 3;
                     ...
                     & static_cast<unsigned int>(
                         ( static_cast<unsigned int>( static_cast<unsigned int>( 0xff ) == 0xff ) ) != 0U ) ) ) )
               != 0U )
        fl = 4;
      else if( ( ( ( c4
                     & static_cast<unsigned int>(
                         static_cast<unsigned int>( ( static_cast<unsigned int>( 0xff ) < 16 ) ) != 0U ) ) ) )
               != 0U )
        fl = 5;
      else if( ( ( ( c4
                     & static_cast<unsigned int>(
                         static_cast<unsigned int>( ( static_cast<unsigned int>( 0xff ) < 64 ) ) != 0U ) ) ) )
               != 0U )
        fl = 6;
      else
        fl = 7;
...
void im1bitModel( Mixer &m, int w ) {
  ...
  cxt[5] = 0x1000
           + ( static_cast<int>( ( static_cast<int>( static_cast<int>( ( ( r0 ) ) == ( 0U ) ) & 0x444 ) ) )
               | ( r1 & 0xC0C ) | ( r2 & 0xAE3 ) | ( r3 & 0x51C ) );
  cxt[6] = 0x2000 + ( ( r0 & 1 ) | ( r1 >> 4 & 0x1d ) | ( r2 >> 1 & 0x60 ) | ( r3 & 0xC0 ) );
  cxt[7] = 0x4000
           + ( ( r0 >> 4 & 0x2AC ) | ( r1 & 0xA4 ) | ( r2 & 0x349 )
               | static_cast<int>( ( static_cast<int>( static_cast<int>( ( ( r3 ) ) == ( 0U ) ) & 0x14D ) ) ) );
...
Filetype detect( FILE *in, int n, Filetype type, int &info ) {
  ...
  for( int i = 0; i < n; ++i ) {
      ...
      const int chn =
          ( ( buf0 >> 24 ) == 0x36
                ...
                : ( ( ( buf0 >> 24 ) == 0x38
                      || ( ( ( ( ( buf0
                                   & static_cast<unsigned int>(
                                       ( static_cast<unsigned int>( static_cast<unsigned int>( 0xff ) == 0x38 ) )
                                       != 0U ) ) ) ) )
                           != 0U ) )
                        ? 8
                        : 4 ) );
    ...
    if( cmode != 6 && txtStart == 0 && ( soi == 0 ) && ( pgm == 0 ) && ( rgbi == 0 ) && ( bmp == 0 ) && ( wavi == 0 )
        && ( tga == 0 ) && ( ( c < 128 && c > 32 ) || c == 10 || c == 13 || c == 0x12 || c == 9 ) )
      txtStart = 1, txtOff = i;
    if( txtStart != 0 ) {
...
void setDefaultModels( const char *filename ) {
  ...
  if( cmode == 6 ) {
    ...
    defaultmodels[4] = wordModel;
    defaultmodels[5] = nestModel;
    defaultmodels[6] = sparseTextModel;
    return;
  }
...
// To compress to file1.paq8q: paq8q [-n] file1 [file2...]
// To decompress: paq8q file1.paq8q [output_dir]
