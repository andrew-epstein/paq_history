  ...
  if( bpos == 0 ) {
    ...
    if( ( ( ( c4 & ( static_cast<unsigned int>( static_cast<unsigned int>( 0xff ) != 0 ) ) != 0u ) ) ) != 0u ) {
      if( isalpha( c4 & 0xff ) != 0 )
        ...
        fl = 4;
      else if( ( ( ( c4 & ( static_cast<unsigned int>( ( static_cast<unsigned int>( 0xff ) < 16 ) ) != 0u ) ) ) )
               != 0u )
        fl = 5;
      else if( ( ( ( c4 & ( static_cast<unsigned int>( ( static_cast<unsigned int>( 0xff ) < 64 ) ) != 0u ) ) ) )
               != 0u )
        fl = 6;
      else
        fl = 7;
...
void im1bitModel( Mixer &m, int w ) {
  ...
  cxt[5] = 0x1000
           + ( static_cast<int>( ( static_cast<int>( ( ( ( r0 ) ) == ( 0u ) ) & 0x444 ) ) ) | ( r1 & 0xC0C )
               | ( r2 & 0xAE3 ) | ( r3 & 0x51C ) );
