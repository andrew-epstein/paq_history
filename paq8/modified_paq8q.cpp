  ...
  if( bpos == 0 ) {
    ...
    if( ( ( ( c4 & static_cast<unsigned int>(( static_cast<unsigned int>( static_cast<unsigned int>( 0xff ) != 0 ) ) != 0U) ) ) ) != 0U ) {
      if( isalpha( c4 & 0xff ) != 0 )
        ...
        fl = 4;
      else if( ( ( ( c4 & static_cast<unsigned int>( static_cast<unsigned int>( ( static_cast<unsigned int>( 0xff ) < 16 ) ) != 0U ) ) ) )
               != 0U )
        fl = 5;
      else if( ( ( ( c4 & static_cast<unsigned int>( static_cast<unsigned int>( ( static_cast<unsigned int>( 0xff ) < 64 ) ) != 0U ) ) ) )
               != 0U )
        fl = 6;
      else
        fl = 7;
...
void im1bitModel( Mixer &m, int w ) {
  ...
  cxt[5] = 0x1000
           + ( static_cast<int>( ( static_cast<int>( static_cast<int>( ( ( r0 ) ) == ( 0U ) ) & 0x444 ) ) ) | ( r1 & 0xC0C )
               | ( r2 & 0xAE3 ) | ( r3 & 0x51C ) );
    ...
    if( ( buf0 == 0x4d2e4b2e || buf0 == 0x3643484e || buf0 == 0x3843484e // M.K. 6CHN 8CHN
      ...
      const int chn =
          ( ( buf0 >> 24 ) == 0x36
                ...
                : ( ( ( buf0 >> 24 ) == 0x38
                      || ( ( ( ( ( buf0
                                   & static_cast<unsigned int>(( static_cast<unsigned int>( static_cast<unsigned int>( 0xff ) == 0x38 ) )
                                         != 0U) ) ) ) )
                           != 0U ) )
                        ? 8
                        : 4 ) );
