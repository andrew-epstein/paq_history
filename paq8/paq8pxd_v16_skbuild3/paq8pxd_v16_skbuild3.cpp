/* paq8pxd16_skbuild3 file compressor/archiver. 13 December 2014
...
inline U64 CMlimit( U64 size ) {
  if( size > 0x80000000 )
    return 0x80000000; //limit to 2GB power of 2
  return ( size );
}
...
Filetype detect( FILE *in, uint64_t n, Filetype type, int &info, int &info2, int it = 0, int s1 = 0 ) {
  ...
  for( uint64_t i = 0; i < n; ++i ) {
    ...
    if( ( buf0 == 0x88F02733 && buf1 == 0x535A4444 ) || ( buf1 == 0x535A2088 && buf0 == 0xF02733D1 ) )
      fSZDD = i;
  ...
  try {
    ...
    if( argc < 2 ) {
      printf( "                                        ___             _ \n"
              ...
              "_______________________|_|___________|_|___|_|_____________________v16_skbuild3\n"
              "\n"
              "              paq8pxd16 archiver (C) 2008,2014, Matt Mahoney et al.\n"
