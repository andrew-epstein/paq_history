...
void im24bitModel( Mixer &m, int w ) {
  ...
  if( bpos == 0 ) {
    ...
    int pxW = buf( 1 );
    int pxWW = buf( 2 + color - 1 );
    int pxNE = buf( w - 2 + color - 1 );
    int pxN = buf( w - 1 + color - 1 );
    int pxNW = buf( w + color - 1 );
    int pxNWW = buf( w + 1 + color - 1 );
    int pxNNE = buf( w * color - 2 + color - 1 );
    int pxNN = buf( w * color - 1 + color - 1 );
