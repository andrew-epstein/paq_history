...
int contextModel2() {
  ...
  static const char* typenames[9]={"", "JPEG ", "HDR ", "1BIT ", "8BIT ",
    "24BIT ", "WAVE ", "EXE ", "TEXT "};
  ...
  switch (filetype) {
    case JPEG: if (jpegModel(m)) return m.p(); break;
    case AUDIO: return wavModel(m, info), m.p();
    case IMAGE1: im1bitModel(m, info); break;
    case IMAGE8: return im8bitModel(m, info), m.p();
    case IMAGE24: return im24bitModel(m, info), m.p();
  }
  ...
  if (bpos==0) {
    ...
    for (i=15; i>0; --i) cxt[i]=cxt[i-1]*257+(c4&255)+1;
    for (i=0; i<7; ++i) cm.set(cxt[i]);
    rcm7.set(cxt[7]);
    cm.set(cxt[8]);
    rcm9.set(cxt[10]);
    rcm10.set(cxt[12]);
...
public:
  ...
  void compress(int c) {
    ...
    if (level==0) putc(c, archive);
    else 
      for (int i=7; i>=0; --i) code((c>>i)&1);
  }
...
Filetype detect(FILE* in, int n, Filetype type, int &info) {
  ...
  // For TEXT
  int txtStart=0,txtLen=0,txtOff=0,txtUTF8b4=0,txtUTF8b5=0,txtUTF8b6=0,txtIsUTF8=-1,txtUTF8b2=0,txtUTF8b3=0;
  ...
  for (int i=0; i<n; ++i) {
    ...
    if (txtStart) {
			if ((c<128 && c>=32) || c==10 || c==13 || c==0x12 || c==9) txtLen++;
			//if possible UTF8 2 byte
			else if (((c&0xe0)==0xc0) && txtUTF8b2==0 && txtUTF8b3==0) txtLen++,txtUTF8b2=1;
			else if (((buf0&0xE0C0)==0xC080) && txtUTF8b2==1) txtLen++,txtUTF8b2=0,txtIsUTF8=1;
			//if possible UTF8 3 byte
			else if (((c&0xf0)==0xe0) && txtUTF8b3==0 && txtUTF8b2==0) txtLen++,txtUTF8b3=1,txtIsUTF8=1;
			else if (((buf0&0xF0C0)==0xE080) && txtUTF8b3==1) txtLen++,txtUTF8b3=2;
			else if (((buf0&0xF0C0C0)==0xE08080) && txtUTF8b3==2) txtLen++,txtUTF8b3=0;
			//if possible UTF8 4 byte
			else if (((c&0xf8)==0xf0) && txtUTF8b4==0 && txtUTF8b3==0 && txtUTF8b2==0) txtLen++,txtUTF8b4=1,txtIsUTF8=1;
			else if (((buf0&0xF8C0)==0xf080) && txtUTF8b4==1) txtLen++,txtUTF8b4=2;
			else if (((buf0&0xF8C0C0)==0xf08080) && txtUTF8b4==2) txtLen++,txtUTF8b4=3;
			else if (((buf0&0xF8C0C0C0)==0xf0808080) && txtUTF8b4==3) txtLen++,txtUTF8b4=0;
			//if possible UTF8 5 byte
			else if (((c&0xFC)==0xf8) && txtUTF8b5==0 && txtUTF8b4==0 && txtUTF8b3==0 && txtUTF8b2==0)
				txtLen++,txtUTF8b5=1,txtIsUTF8=1;
			else if (((buf0&0xfcc0)==0xf880) && txtUTF8b5==1) txtLen++,txtUTF8b5=2;
			else if (((buf0&0xfcc0c0)==0xf88080) && txtUTF8b5==2) txtLen++,txtUTF8b5=3;
			else if (((buf0&0xfcc0c0c0)==0xf8808080) && txtUTF8b5==3) txtLen++,txtUTF8b5=4;
			else if (((buf0&0xc0c0c0c0)==0x80808080) && txtUTF8b5==4) txtLen++,txtUTF8b5=0;
			//if possible UTF8 6 byte
			else if (((c&0xFE)==0xfc) && txtUTF8b6==0 && txtUTF8b5==0 && txtUTF8b4==0 && txtUTF8b3==0 && txtUTF8b2==0)
				txtLen++,txtUTF8b6=1,txtIsUTF8=1;
			else if (((buf0&0xfec0)==0xfc80) && txtUTF8b6==1) txtLen++,txtUTF8b6=2;
			else if (((buf0&0xfec0c0)==0xfc8080) && txtUTF8b6==2) txtLen++,txtUTF8b6=3;
			else if (((buf0&0xfec0c0c0)==0xfc808080) && txtUTF8b6==3) txtLen++,txtUTF8b6=4;
			else if (((buf0&0xc0c0c0c0)==0x80808080) && txtUTF8b6==4) txtLen++,txtUTF8b6=5;
			else if (((buf0&0xc0c0c0c0)==0x80808080) && txtUTF8b6==5) txtLen++,txtUTF8b6=0;
			else if (txtLen<txtMinLen) txtStart=txtLen=txtOff=txtUTF8b2=txtUTF8b3=txtUTF8b4=0,txtIsUTF8=-1;
			else if (txtLen>=txtMinLen) {
				if (txtUTF8b2==1) --txtLen;
				if (txtUTF8b3==1) --txtLen;
				else if (txtUTF8b3==2) --txtLen,--txtLen;
				if (txtUTF8b4==1) --txtLen;
				else if (txtUTF8b4==2) --txtLen,--txtLen;
				else if (txtUTF8b4==3) --txtLen,--txtLen,--txtLen;
				if (txtUTF8b5==1) --txtLen;
				else if (txtUTF8b5==2) --txtLen,--txtLen;
				else if (txtUTF8b5==3) --txtLen,--txtLen,--txtLen;
				else if (txtUTF8b5==4) --txtLen,--txtLen,--txtLen,--txtLen;
				if (txtUTF8b6==1) --txtLen;
				else if (txtUTF8b6==2) --txtLen,--txtLen;
				else if (txtUTF8b6==3) --txtLen,--txtLen,--txtLen;
				else if (txtUTF8b6==4) --txtLen,--txtLen,--txtLen,--txtLen;
				else  if (txtUTF8b6==5) --txtLen,--txtLen,--txtLen,--txtLen,--txtLen;
				if (type==TEXT) return fseek(in, start+txtLen, SEEK_SET),DEFAULT;
