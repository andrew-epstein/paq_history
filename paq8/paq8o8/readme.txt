paq8o8 archiver, released by KZ, Oct. 22, 2007.

Copyright (C) 2007 Matt Mahoney, Serge Osnach, Alexander Ratushnyak,
Bill Pettis, Przemyslaw Skibinski, Matthew Fite, wowtiger, Andrew Paterson,
Jan Ondrus, Andreas Morphis, Pavel L. Holoborodko, KZ, Michael Adams.
...
Contents:
  ...
  paq8o8.exe - Win32 executable
  paq8o8.cpp - C++ source code.
  ...
  paq7goasm.asm - GoAsm port of paq7asm.asm by Michael Adams (Feb 17 2008).

paq8o8 by KZ 
improved JPEG model by Jan Ondrus

See paq8o8.cpp source comments for usage and compiling instructions.
