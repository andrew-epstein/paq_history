...
int level = DEFAULT_OPTION; // Compression level 0 to 10
...
void wordModel( Mixer &m ) {
  ...
  static ContextMap cm( MEM * 32, 44 );
...
void dmcModel( Mixer &m ) {
  ...
  static Array<DMCNode> t( MEM ); // state graph
  static StateMap sm;
  ...
  try {
    ...
    if( argc < 2 ) {
      printf( "                                        ___             _ \n"
              ...
              "_______________________|_|___________|_|___|_|______________v12-skbuild-1-win64\n"
              "\n"
              ...
              "\n"
              "Levels: -0 = store  (39 MB)  | -4 = smaller  (184 MB) |  -8 = smaller (1795 MB)\n"
              "        -1 = faster (89 MB)  | -5 = smaller  (284 MB) |------------------------\n"
              "        -2 = faster (95 MB)  | -6 = smaller  (491 MB) |  -9 = exp (3535 MB) *\n"
              "        -3 = faster (106 MB) | -7 = smaller  (926 MB) | -10 = exp (7015 MB) **\n"
              "\n"
              "  * - experimental option\n"
              " ** - experimental option, used by default !\n"
              "      don't assign any -level to use -10\n"
              "\n"
