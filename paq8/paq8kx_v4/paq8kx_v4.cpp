...
int chartModel( Mixer &m, int ismatch ) {
  ...
  if( !bpos ) {
    const int w = c4 & 65535;
    int w0 = c4 & 16777215;
    int w1 = c4 & 255;
    int w2 = c4 << 8 & 65280;
    int w3 = c4 << 8 & 16711680;
    int w4 = c4 << 8 & 4278190080;
    int a[3] = {c4 >> 5 & 460551, c4 >> 2 & 460551, c4 & 197379};
    int b[3] = {c4 >> 23 & 448 | c4 >> 18 & 56 | c4 >> 13 & 7, c4 >> 20 & 448 | c4 >> 15 & 56 | c4 >> 10 & 7,
                c4 >> 18 & 48 | c4 >> 12 & 12 | c4 >> 8 & 3};
    int d[3] = {c4 >> 15 & 448 | c4 >> 10 & 56 | c4 >> 5 & 7, c4 >> 12 & 448 | c4 >> 7 & 56 | c4 >> 2 & 7,
                c4 >> 10 & 48 | c4 >> 4 & 12 | c4 & 3};
    int c[3] = {c4 & 255, c4 >> 8 & 255, c4 >> 16 & 255};

    for( int i = 0, j = 0, f = b[0], e = a[0]; i < 3; j = i++ << 9, f = j | b[i], e = a[i] ) {
