  ...
  try {
    ...
    if (argc>1 && argv[1][0]=='-' && argv[1][1] && !argv[1][2]) {
      if (argv[1][1]>='0' && argv[1][1]<='9')
        ...
        quit("Valid options are -0 through -9, -d, -l\n");
      --argc;
      ++argv;
      pause=false;
    }
...
"_______________________|_|___________|_|___|_|______________v12-skbuild-1-win32\n"
"\n"
...
"   paq8pxd12 file                 (level -5, pause when done)\n"
...
"        -3 = faster (106 MB) | -7 = smaller  (926 MB) | -10 = x64 (7015 MB) **\n"
"\n"
"  * - experimental option, can cause \"not enough memory\" error in x86 build\n"
" ** - experimental option, available in x64 build only\n"
"\n"
