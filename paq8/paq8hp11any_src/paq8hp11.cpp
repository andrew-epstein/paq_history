...
void sparseModel( Mixer &m ) {
  ...
  static SmallStationaryContextMap scm1( 0x20000, 16 ), scm2( 0x20000, 12 ), scm3( 0x20000, 12 ), scm4( 0x20000, 13 ),
...
int main( int argc, char **argv ) {
  ...
  {
    buf.setsize( MEM * 8 );
    FILE *dictfile = fopen( "./to_train_models.dic", "rb" ), *tmpfi = fopen( "./tmp_tmp_tmp_tmp.dic", "wb" );
    filetype = 0;
