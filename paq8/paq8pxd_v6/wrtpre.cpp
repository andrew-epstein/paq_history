...
void XWRT_Common::initializeLetterSet() {
  ...
  for( c = 0; c < 256; c++ ) //                                                - _ . , :
    if( c > 127 || letterSet[c] == LOWERCHAR || letterSet[c] == UPPERCHAR || letterSet[c] == NUMBERCHAR
        || c == ' ' /*|| c=='\''*/ ) // || c=='&')
      wordSet[c] = 1;
    else
      wordSet[c] = 0;
...
int __cdecl compare_str( const void *arg1, const void *arg2 ) {
  int a = *( int * ) arg1;
  int b = *( int * ) arg2;
...
int __cdecl compare_freq( const void *arg1, const void *arg2 ) {
  int a = *( int * ) arg1;
  int b = *( int * ) arg2;
