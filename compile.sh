...
function task() {
	...
	echo "$FILENAME"
	FILENAME="${FILENAME%.*}"
	$CXX -Weverything -Wall -Wextra $WARN -fomit-frame-pointer -fno-stack-protector -lz -fno-rtti -std=c++14 -O3 -m64 -march=native -funroll-loops -ftree-vectorize -DUNIX $1 asm/paq7asm.s -o bin/$FILENAME
