// fpaq0s3 - Stationary order 0 file compressor.
...
unsigned long cxt;             // Context: last 0-24 bits with a leading 1
unsigned char ct[16777216][2]; // 0 and 1 counts in context cxt . Only [32MB]
                               //////////////////////////// Predictor /////////////////////////
...
// Assume a stationary order 0 stream of 24-bit symbols
int p() {
