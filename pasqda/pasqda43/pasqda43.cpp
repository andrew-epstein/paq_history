/* PAsQDa 4.3, based on PAQAR 4.0 - File archiver and compressor.
...
#endif
#define LONG_PROGNAME PROGNAME " (PAQ+Dictionary) 4.3"
#define CREATION_DATE "07.12.2005"
			 ...
			 if (f) {      // PAsQDa addon
 			 ...
 			 // Extract to new file
				 ...
				 if (f && size>0)
				 {
					...
					WRT_decode(archive,f,size+exe); // PAsQDa addon
