/* PAsQDa 2.0, based on PAQAR 4.0 - File archiver and compressor.
...
reasonable tradeoff.  Recommended options are:
  ...
  -0 to -2 for fast but not very good compression, uses ~18-25 Mb memory
  -3 for reasonably fast and good compression,
  -4 better compression but slower,
  -5 the default, slightly better compression, uses ~130 Mb,
  -6 about like -5, uses ~240 Mb,
  -7 to -9 use ~470 Mb, ~930 Mb, ~1850 Mb, about the same speed as -6
...
#define LONG_PROGNAME "PAsQDa (PAQ+Dictionary) v2.0"
#define CREATION_DATE "24.01.2005"
