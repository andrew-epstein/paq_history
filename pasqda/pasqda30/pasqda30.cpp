/* PAsQDa 3.0, based on PAQAR 4.0 - File archiver and compressor.
...
#define LONG_PROGNAME "PAsQDa (PAQ+Dictionary) v3.0"
#define CREATION_DATE "07.02.2005"
...
int wlen,clen,fsize,tf,po,bp,lon,z=0,restrt=0;
U8 l8=0;
...
protected:
	...
	int en;
public:
	Mixer(int n):wt(new U32[n][65]),sse(new SSEContext[2048][33]){ en=n; }
	void init()
	{
		for(int i=0;i<en;i++)
			for(int j=0;j<65;j++)
...
cm.add();         -- Predict and add to previously written counts
 ...
 class CharModel{
	 ...
	 U32 *snap_cxt;
 public:
	 CharModel():t2(21),t3(23),t4(23),t5(24),t6(24),t7(24),t8(24),t9(23),ta(23) { snap_cxt=NULL; snap_t0=NULL; }
 	 void init() 
	 {
		 t2.init();
		 t3.init();
