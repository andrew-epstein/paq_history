/* PAsQDa 4.2, based on PAQAR 4.0 - File archiver and compressor.
...
#endif
#define LONG_PROGNAME PROGNAME " (PAQ+Dictionary) 4.2"
#define CREATION_DATE "05.12.2005"
...
#endif
 public:
//	 CharModel():t2(21),t3(23),t4(23),t5(24),t6(24),t7(24),t8(24),t9(23),ta(23) 
	 CharModel():t2(21),t3(23),t4(23),t5(23),t6(23),t7(23),t8(23),t9(23),ta(23) 
	 { 
#ifdef CALGARY_CORPUS_OPTIM
		 snap_cxt=NULL; 
		 snap_t0=NULL; 
...
int main(int argc, char** argv) {
...
#ifdef CALGARY_CORPUS_OPTIM
			 " -0 (fastest)        32 Mb  (35 Mb for Calgary corpus)\n"
			 " -1                  34 Mb  (40 Mb for Calgary corpus)\n"
			 " -2                  40 Mb  (51 Mb for Calgary corpus)\n"
			 " -3                  52 Mb  (74 Mb for Calgary corpus)\n"
			 " -4                  72 Mb (102 Mb for Calgary corpus)\n"
			 " -5 (default)       122 Mb (175 Mb for Calgary corpus)\n"
	...
	for (int i=1; i<argc && (argv[i][0]=='-' || argv[i][0]=='/'); argc--,argv++)
	{
		...
		{
            case 'W': o_w=CLAMP(atoi(argv[i]+2),0,32); break; // SSE to predicion weight balance (depends on file type)
            case 'P': o_p=CLAMP(atoi(argv[i]+2),0,4096); break;
            default : 
				if (isdigit(argv[1][1])) 
				{
	 ...
	 if (archive) {
		...
		do
		{
			...
			switch (s[pos+1]) 
			{
				...
				case 'p': o_p=atoi(&s[pos+2]); break; // SSE to predicion weight balance (depends on file type)
				default : 
				if (isdigit(s[pos+1]))
				{
					 // Read and remove -MEM option
