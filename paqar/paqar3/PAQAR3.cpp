/*
PAQAR 3.0 - Experimental version by Alexander Ratushnyak - File archiver and compressor.
...
public:
  ...
  void upd( int y ) {
    ...
    if( tf )
      nextp = ( ( 3 * p3 + 6 * p1 + 5 * p2 + 2 * p4 + 1 * p5 ) * 11 / 32 + 8 + nextp * 17 ) / ( 17 * 12 );
    else
...
int main( int argc, char **argv ) {
  // Check arguments
  if( argc < 2 ) {
    printf( PROGNAME " v3.0 file compressor/archiver, (C)2004, Matt Mahoney, mmahoney@cs.fit.edu\n"
