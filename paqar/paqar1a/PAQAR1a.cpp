...
int r1,r2,c1,c2;
public:
RecordModel():t0(17-MEM),t1(19-MEM),t2(20-MEM),t3(SIZE),t4(SIZE),t5(SIZE),t6(SIZE),t7(SIZE),r1(2),r2(3),c1(0),c2(0){}
void model(){
if(!bp){
int c=ch(1);
...
int main(int argc, char** argv) {
  ...
  if (argc<2) {
    printf(
      PROGNAME " v1.0 file compressor/archiver, (C)2004, Matt Mahoney, mmahoney@cs.fit.edu\n"
