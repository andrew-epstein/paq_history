/*
PAQAR 4.1 - Experimental version by Alexander Ratushnyak - File archiver and compressor.
...
int main( int argc, char **argv ) {
  // Check arguments
  if( argc < 2 ) {
    printf( PROGNAME " v4.1 file compressor/archiver, (C)2004, Matt Mahoney, mmahoney@cs.fit.edu\n"
