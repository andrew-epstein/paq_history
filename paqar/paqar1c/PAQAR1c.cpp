/*
PAQAR 1.2 - Experimental version by Alexander Ratushnyak - File archiver and compressor.
...
U32 wt=ssep&31;
ssep/=32;
p=((sse[c][ssep].p()*(32-wt)+sse[c][ssep+1].p()*wt)*27/32+p*5)/32;
return p;
}
...
public:
MultiMixer():m0(256),m1(256),m2(256),m3(256),m4(2048),m5(2048),m6(256),m7(256),m8(2048),m9(2048),ma(2048),mb(2048){}
...
public:
RecordModel():t0(17-MEM),t1(19-MEM),t2(20-MEM),t3(SIZE),t4(SIZE),t5(SIZE),t6(SIZE),t7(SIZE),t8(SIZE),t9(SIZE),ta(SIZE),r1(2),r2(3),r3(2),r4(3),c1(0),c2(0){}
void model(){
if(!bp){
int c=ch(1);
...
int main(int argc, char** argv) {
  ...
  if (argc<2) {
    printf(
      PROGNAME " v1.2 file compressor/archiver, (C)2004, Matt Mahoney, mmahoney@cs.fit.edu\n"
