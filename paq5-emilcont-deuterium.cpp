...
public:
  CharModel(): t0(new Counter[256]), t1(new Counter[65536]),	
               t2(20), t3(22), t4(23), t5(23),						//	emilcont
               t6(23), t7(23), t8(23), t9(23),  cxt(new U32[N]) {			//	emilcont
    cp0=&t0[0];
    cp1=&t1[0];
...
public:
  RecordModel(): t0(22), t1(22), repeat(1) {}				
  void model(); 
} recordModel;
...
class SparseModel: public Model {
  enum {N=10};                      // Number of models
  CounterMap 		t0, t1, t2, t3,
  			t4, t5, t6, t7, 
  			t8, t9;  // Sparse models
public:
  SparseModel(): t0(20), t1(20), t2(20),
...
class AnalogModel: public Model {
  ...
  int pos3;  // pos % 3
public:
  AnalogModel(): t0(18), t1(18), t2(18), t3(18),			//F22,F23,F24,F25 - Emilcont (18,18,18,18)
      t4(18), t5 (18), pos3(0) {}					//F26,F27 - Emilcont (18,18)
  void model() {
    if (ch.bpos()==0) {
      if (++pos3==3) pos3=0;
