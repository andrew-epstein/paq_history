/* PAQ6-Emilcont-Annyhilator - Experimental version by Emilcont AKA Berto Destasio - File archiver and compressor.
(C) 2004, Matt Mahoney, mmahoney@cs.fit.edu, Fabio Buffoni, David Scott,
          Jason Schmidt, Berto Destasio AKA EMILCONT
...
#define PROGNAME "PAQ6-EmilCont-Annyhilator"  // Please change this if you change the program
...
//  ---- ---- --- --- --- --- ---------  ----------   ----- -- --
    ...
    {  2,  3,  8, 13, 11, 16,4294967295u,4294967295u}, // 17 (2,3)
    {  3,  2, 13, 19,  7, 11,4294967295u,4294967295u}, // 18 (3,2)
    ...
    {  1,  3, 12, 18, 16, 22,4294967295u,4294967295u}, // 23 (2,4)
    {  3,  3, 13, 19, 11, 16,4294967295u,4294967295u}, // 24 (3,3)
    {  3,  1, 19, 26, 12, 17,4294967295u,4294967295u}, // 25 (4,2)
    ...
    {  0,160, 71, 80,209,215,4294967295u,1073741823u/8}, // 209 (0,40)
    {  1, 39, 80, 89,210,213,4294967295u,4294967295u}, // 210 (1,39)
    { 39,  1,211,214, 85, 90,4294967295u,4294967295u}, // 211 (39,1)
    {160,  0,212,216, 78, 85,1073741823u/8,4294967295u}, // 212 (40,0)
    {  1, 40, 80, 89,213,217,4294967295u,1073741823u/8}, // 213 (1,40)
    { 40,  1,214,218, 85, 90,1073741823u/8,4294967295u}, // 214 (40,1)
    {  0,176, 71, 80,215,219,4294967295u,1073741823u/8}, // 215 (0,44)
    {176,  0,216,220, 78, 85,1073741823u/8,4294967295u}, // 216 (44,0)
    {  1, 44, 80, 89,217,221,4294967295u,1073741823u/8}, // 217 (1,44)
    { 44,  1,218,222, 85, 90,1073741823u/8,4294967295u}, // 218 (44,1)
    {  0,192, 71, 80,219,223,4294967295u, 536870911u/8}, // 219 (0,48)
    {192,  0,220,224, 78, 85, 536870911u/8,4294967295u}, // 220 (48,0)
    {  1, 48, 80, 89,221,225,4294967295u, 536870911u/8}, // 221 (1,48)
    { 48,  1,222,226, 85, 90, 536870911u/8,4294967295u}, // 222 (48,1)
    {  0,224, 79, 88,223,227,4294967295u, 536870911u/8}, // 223 (0,56)
    {224,  0,224,228, 86, 91, 536870911u/8,4294967295u}, // 224 (56,0)
    {  1, 56, 88, 95,225,229,4294967295u, 536870911u/8}, // 225 (1,56)
    { 56,  1,226,230, 91, 96, 536870911u/8,4294967295u}, // 226 (56,1)
    {  0,256, 87, 94,227,231,4294967295u, 134217727u/8}, // 227 (0,64)
    {256,  0,228,232, 92, 97, 134217727u/8,4294967295u}, // 228 (64,0)
    {  1, 64, 94,101,229,233,4294967295u, 134217727u/8}, // 229 (1,64)
    { 64,  1,230,234, 97,102, 134217727u/8,4294967295u}, // 230 (64,1)
    {  0,384, 93,100,231,235,4294967295u, 134217727u/8}, // 231 (0,96)
    {384,  0,232,236, 98,103, 134217727u/8,4294967295u}, // 232 (96,0)
    {  1, 96,100,107,233,237,4294967295u, 134217727u/8}, // 233 (1,96)
    { 96,  1,234,238,103,108, 134217727u/8,4294967295u}, // 234 (96,1)
    {  0,512,105,112,235,239,4294967295u, 134217727u/8}, // 235 (0,128)
    {512,  0,236,240,110,113, 134217727u/8,4294967295u}, // 236 (128,0)
    {  1,128,112,117,237,241,4294967295u, 134217727u/8}, // 237 (1,128)
    {128,  1,238,242,113,118, 134217727u/8,4294967295u}, // 238 (128,1)
    {  0,640,111,116,239,243,4294967295u, 134217727u/8}, // 239 (0,160)
    {640,  0,240,244,114,119, 134217727u/8,4294967295u}, // 240 (160,0)
    {  1,160,116,123,241,245,4294967295u, 134217727u/8}, // 241 (1,160)
    {160,  1,242,246,119,124, 134217727u/8,4294967295u}, // 242 (160,1)
    {  0,768,115,122,243,247,4294967295u, 134217727u/8}, // 243 (0,192)
    {768,  0,244,248,120,125, 134217727u/8,4294967295u}, // 244 (192,0)
    {  1,192,122,129,245,249,4294967295u, 134217727u/8}, // 245 (1,192)
    {192,  1,246,250,125,130, 134217727u/8,4294967295u}, // 246 (192,1)
    {  0,896,121,128,247,251,4294967295u, 138547332u/8}, // 247 (0,224)
    {896,  0,248,252,126,131, 138547332u/8,4294967295u}, // 248 (224,0)
    {  1,224,128,135,249,253,4294967295u, 138547332u/8}, // 249 (1,224)
    {224,  1,250,254,131,136, 138547332u/8,4294967295u}, // 250 (224,1)
...
public:
  ...
  void set(U32 h) {
    ...
    for (i=lo; i<hi; ++i) {
      ...
      else if (table[i].c[0].priority()==0) {  // empty bucket
...
Hashtable<T>::Hashtable(U32 n): N(n>4?n-4:1), table(0), cxt(0) {
  ...
  char *p=(char*)calloc((16<<N)+64, 1);  //  char *p=(char*)calloc((16<<N)+64, 1);
  if (!p)
    handler();
  p+=64-(((long)p)&63);  // Aligned  p+=64-(((int)p)&63);
  table=(HashElement*)p;
  Tcxt=&(table[0].c[-1]);
...
class Mixer {
protected:
  enum {N=100};  // Max writes before update
  const int C;
...
inline void CharModel::model() {
  ...
  if (ch.bpos()==0) {  // Start new byte
    for (int i=N-1; i>0; --i)
      cxt[i]=cxt[i-1]^hash(ch(1),i,(_wlen==i && ch.pos(0, 3) < ch.pos(32, 3) && ch.pos(255, 3) < ch.pos(32, 3)));
    t2.update(cxt[2]);
    t3.update(cxt[3]);
    t4.update(cxt[4]);
    if (MEM>=1)
...
class RecordModel: public Model {
  ...
  int _c1,_c2;
public:
  RecordModel(): SIZE((MEM>=4)*(15+MEM-(MEM>=6))),
...
inline void RecordModel::model() {
  if (ch.bpos()==0) {
    ...
    t3.update(hash(ch(r2), ch(r2*2)>>2, r2));  // 2 above (longer repeat)
    t4.update(hash(ch(1), ch(r2), ch(r2+1), r2));     // above and left
    t5.update(hash(ch(1), ch(r1), ch(r1+2), r1));     // above and left
...
class RecordModel2: public Model {
  const int SIZE;
  enum {N=2};           // Number of models
  CounterMap t0, t1, t2, t3, t4, t5;  // Model
  int repeat1, repeat2;  // 2 last cycle lengths
  int _c1,_c2;
public:
  RecordModel2(): SIZE((MEM>=4)*(15+MEM-(MEM>=6))),
                 t0(SIZE), t1(SIZE), t2(SIZE), t3(SIZE), t4(SIZE), t5(SIZE),
                 repeat1(2), repeat2(3), _c1(0), _c2(0) {}
  void model(); 
};
...
// Update the model with bit y, then put predictions of the next update
// as 0 counts in n0[0..N-1] and 1 counts in n1[0..N-1]
inline void RecordModel2::model() {
  if (ch.bpos()==0) {
   ...
   t5.update(hash(ch(1), ch(r1), ch(r1+4), r1));     
...
class RecordModel3: public Model {
  const int SIZE;
  enum {N=2};           // Number of models
  ...
  int _c1,_c2;
public:
  RecordModel3(): SIZE((MEM>=4)*(15+MEM-(MEM>=6))),
                 t0(SIZE), t1(SIZE), t2(SIZE), t3(SIZE), t4(SIZE)  ,  t5(SIZE)  ,  t6(SIZE)  ,
                 repeat1(2), repeat2(3), _c1(0), _c2(0) {}
  void model(); 
};
...
// Update the model with bit y, then put predictions of the next update
// as 0 counts in n0[0..N-1] and 1 counts in n1[0..N-1]
inline void RecordModel3::model() {
  if (ch.bpos()==0) {
 ...
 t5.update(hash(ch(1), ch(r1), ch(r1+5), r1));     
 t6.update(hash(ch(r1), ch(r1*3), r1));  
...
inline void SparseModel::model() {
  ...
  if (ch.bpos()==0) {
	...
	t3.update(hash(ch(1), ch(6), k));
  	t4.update(hash(ch(2), ch(3), k));
	t5.update(hash(ch(2), ch(4), k));
	t6.update(hash(ch(3), ch(4), k));
	t7.update(hash(ch(1), ch(2), g/2, k));
	t8.update(hash(ch(1), ch(2), g2/2, k));
  }
...
inline void SparseModel2::model() {
  // Update context
  if (ch.bpos()==0) {
	t0.update(hash(ch(1), ch(11), ch(13), ch(17)));
	t1.update(hash(ch(2), ch(12), ch(15), ch(19)));
	t2.update(hash(ch(3), ch(16), ch(20), ch(23)));
	t3.update(hash(ch(4), ch(14), ch(18), ch(29)));
	
        t4.update(hash(ch(6), ch(9), ch(21), ch(24)));
...
public:
  ...
  void model() {
    if (ch.bpos()==0) {
      ...
      t2.update(hash(ch(4)/4, (ch(2)-ch(6))/4, (ch(4)-ch(8))/8)); // Stereo
...
class Predictor {
  ...
  DefaultModel defaultModel;
    DefaultModel2 defaultModel2;

  CharModel charModel;
  MatchModel matchModel;
  RecordModel recordModel;
  RecordModel2 recordModel2;
  RecordModel3 recordModel3;
...
inline void Predictor::update(int y) {
  ...
  if (MEM>=1) {
    context=ch(0)*8+(ch(1)/64)*2+(ch.pos(0,3)<ch.pos(32,3))*(_wlen==_clen);  // for SSE 64
    ssep=ssemap(nextp);
...
int main(int argc, char** argv) {
  ...
  if (argc<2) {
    printf(
      PROGNAME " v2 file compressor/archiver, (C) 2004, Matt Mahoney, mmahoney@cs.fit.edu\n"
      ...
      "\n"
      "To compress:         " PROGNAME " -3 archive filenames...  (archive will be created)\n"
      "  or (MSDOS):        dir/b | " PROGNAME " -3 archive  (reads file names from input)\n"
