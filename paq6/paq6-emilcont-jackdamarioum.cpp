...
******************
NOTES BY EMILCONT (AKA Berto Destasio)
My implementation brings PAQ6 at the first place in the world (today 28-12-2003).
However other compressors are very close to PAQ5 results, so the war is open.
I'm ready to improve the marvelous PAQ6 (by MATT MAHONEY) in order to bring it ever to the first place.

Dedicated to JACK D'AMARIO
Questo lavoro lo dedico all'amico JACK D'AMARIO
******************
...
//////////////////////////// charModel ////////////////////////////	   		MODIFIED BY EMILCONT
...
public:
  CharModel(): t0(new Counter[256]), t1(new Counter[65536]),
               t2(13+MEM), t3(15+MEM), t4(17+MEM), t5(17+MEM),
               t6(17+MEM), t7(17+MEM),  cxt(new U32[N]) {
    cp0=&t0[0];
    cp1=&t1[0];
...
//////////////////////////// sparseModel ////////////////////////////			MODIFIED BY EMILCONT
...
public:
  SparseModel(): t0(14+MEM), t1(14+MEM), t2(14+MEM),
                 t3(14+MEM), t4(14+MEM), t5(14+MEM), t6(14+MEM), t7(14+MEM), t8(14+MEM), t9(14+MEM){}
  void model();  // Update and predict
} sparseModel;
...
//////////////////////////// analogModel ////////////////////////////			MODIFIED BY EMILCONT
...
class AnalogModel: public Model {
  ...
  int pos3;  // pos % 3
public:
  AnalogModel(): t0(14+MEM), t1(14+MEM), t2(14+MEM), t3(14+MEM),
      t4(14+MEM), t5 (14+MEM), pos3(0) {}
  void model() {
    if (ch.bpos()==0) {
      if (++pos3==3) pos3=0;
