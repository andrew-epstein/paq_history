/* PAQ603fb - experimental - File archiver and compressor.
...
#define PROGNAME "PAQ603" // Please change this if you change the program
...
void Mixer::update( int y, int method ) {
  U32 s0, s1;
