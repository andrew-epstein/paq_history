/* PAQ607fb - Experimental version by Fabio Buffoni - File archiver and compressor.
...
#define PROGNAME "PAQ6-EmilCont-Anny-607fb"  // Please change this if you change the program
...
inline void RecordModel::model() {
 ...
 t2.update(hash(ch(1), ch(r1), ch(r1+2), r1));     // above and left
