...
public:
  ...
  void add() {
    if( static_cast<U32>( ( t[cxt].c + 256 ) >> ( 8 - ch.bpos() ) ) == ch() ) {
...
public:
  SparseModel() : t0( 12 + MEM ), t1( 12 + MEM ), t2( 12 + MEM ), t3( 12 + MEM ), t4( 12 + MEM ), t5( 12 + MEM ) {}
  void model() override; // Update and predict
} sparseModel;
...
class AnalogModel : public Model {
  ...
  int pos3{ 0 }; // pos % 3
public:
  AnalogModel() : t0( 10 + MEM ), t1( 10 + MEM ), t2( 10 + MEM ), t3( 10 + MEM ), t4( 10 + MEM ), t5( 10 + MEM ) {}
  void model() override {
    if( ch.bpos() == 0 ) {
      if( ++pos3 == 3 )
        pos3 = 0;
...
Predictor::Predictor() :
    sse( static_cast<SSEContext ( * )[SSE2 + 1]>( new SSEContext[SSE1][SSE2 + 1] ) ), nextp( PSCALE / 2 ) {
