...
#else
    if( method == TEXT )
      len2order[c] = ( 5 + static_cast<int>( c >= 10 ) + static_cast<int>( c >= 14 ) + static_cast<int>( c >= 19 )
                       + static_cast<int>( c > 28 ) )
                     * MI;
    else
      len2order[c] = ( 5 + static_cast<int>( c >= 8 ) + static_cast<int>( c >= 12 ) + static_cast<int>( c >= 18 )
