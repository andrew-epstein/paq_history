...
#ifdef WIKI
#  define FB_SIZE 8192
#  define TOLIMIT_10 368
#  define TOLIMIT_11 544
#  define TOLIMIT_12 544
#  define TOLIMIT_13 1023
#  define TOLIMIT_14 1023
#  define TOLIMIT_15 1023
#  define TOLIMIT_16 304
...
#ifdef WIKI
#  define E8E9_encode( p, i ) ;
#  define E8E9_decode( p, i ) ;
#else
...
static const U8 State_table[512 * 4] = {
    ...
    44,  46,  48,  50,  52,  54,  56,  58,  60,  62,  64,  66,  68,  70,  72,  74,  76,  78,  80,  82,  84,  86,
    88,  90,  92,  94,  96,  98,  100, 102, 104, 106, 108, 110, 112, 114, 116, 118, 120, 122, 124, 126, 128, 130,
    132, 134, 136, 138, 140, 142, 144, 146, 148, 150, 152, 154, 156, 158, 144, 146, 148, 150, 152, 154, 156, 158,
    160, 162, 164, 166, 168, 170, 172, 174, 144, 146, 148, 150, 152, 154, 156, 158, 160, 162, 164, 166, 168, 170,
    172, 174, 160, 162, 164, 166, 168, 170, 172, 174, 176, 178, 180, 182, 184, 186, 188, 190, 192, 130, 132, 134,
    136, 138, 140, 142, 144, 146, 148, 150, 152, 154, 156, 158, 194, 146, 148, 150, 152, 154, 156, 158, 160, 162,
    164, 166, 168, 170, 172, 174, 144, 146, 148, 150, 152, 154, 156, 158, 160, 162, 164, 166, 168, 170, 172, 174,
    160, 162, 164, 166, 168, 170, 172, 174, 176, 178, 180, 182, 184, 186, 188, 190, 196, 188, 198, 172, 200, 188,
    202, 172, 204, 184, 206, 168, 208, 184, 210, 168, 212, 184, 214, 168, 216, 184, 218, 168, 220, 184, 222, 168,
    224, 184, 226, 168, 228, 184, 230, 168, 232, 184, 234, 168, 236, 184, 238, 168, 240, 184, 242, 168, 244, 184,
    246, 168, 248, 184, 250, 168, 252, 184, 254, 168, 252, 184, 254, 168,
    ...
    45,  47,  49,  51,  53,  55,  57,  59,  61,  63,  65,  67,  69,  71,  73,  75,  77,  79,  81,  83,  85,  87,
    89,  91,  93,  95,  97,  99,  101, 103, 105, 107, 109, 111, 113, 115, 117, 119, 121, 123, 125, 127, 129, 131,
    133, 135, 137, 139, 141, 143, 145, 147, 149, 151, 153, 155, 157, 159, 145, 147, 149, 151, 153, 155, 157, 159,
    161, 163, 165, 167, 169, 171, 173, 175, 145, 147, 149, 151, 153, 155, 157, 159, 161, 163, 165, 167, 169, 171,
    173, 175, 161, 163, 165, 167, 169, 171, 173, 175, 177, 179, 181, 183, 185, 187, 189, 191, 129, 131, 133, 135,
    137, 139, 141, 143, 145, 147, 149, 151, 153, 155, 157, 159, 145, 147, 149, 151, 153, 155, 157, 159, 161, 163,
    165, 167, 169, 171, 173, 175, 145, 147, 149, 151, 153, 155, 157, 159, 161, 163, 165, 167, 169, 171, 173, 195,
    161, 163, 165, 167, 169, 171, 173, 175, 177, 179, 181, 183, 185, 187, 189, 193, 131, 197, 147, 199, 131, 201,
    147, 203, 135, 205, 151, 207, 135, 209, 151, 211, 135, 213, 151, 215, 135, 217, 151, 219, 135, 221, 151, 223,
    135, 225, 151, 227, 135, 229, 151, 231, 135, 233, 151, 235, 135, 237, 151, 239, 135, 241, 151, 243, 135, 245,
    151, 247, 135, 249, 151, 251, 135, 253, 151, 255, 135, 253, 151, 255,
};
...
public:
  ...
  inline int p1( int pr, int cx ) { // int limit)
    assert( y >> 1 == 0 );
    assert( cx >= 0 && cx < N / 24 );
    assert( cxt >= 0 && cxt < N );
    {
...
#define upd3( m0, m1, m2, m3, m4, m5, bc )                                                                             \
  ...
  upd3_cp cp[5] = t2b.get0( hash0( c0 * 37 - h[5] ) );
...
#define upd7( m0, m1, m2, m3, m4, m5 )                                                                                 \
  cp_update( m0, m1, m2, m3, m4, m5 ) {                                                                                \
    ...
    upd7_cp cp[5] = t2a.get1( hash5( h[5] - pw ) );                                                                    \
    c0 = 1;                                                                                                            \
    bcount = 7;                                                                                                        \
    mm.upd();                                                                                                          \
  }
...
#  define eight_bits( part1, part2 )                                                                                   \
    ...
    {                                                                                                                  \
      part1( 7 );                                                                                                      \
      upd0( 3, 3, 1, 0, 0, 0, 6, 0 );                                                                                  \
      part2;                                                                                                           \
    }                                                                                                                  \
    {                                                                                                                  \
      part1( 6 );                                                                                                      \
      upd0( 1, 3, 1, 0, 0, 0, 5, 1 );                                                                                  \
      part2;                                                                                                           \
    }                                                                                                                  \
    sm[1].t += 256;                                                                                                    \
    {                                                                                                                  \
      part1( 5 );                                                                                                      \
      upd0( 1, 3, 1, 0, 0, 0, 4, 2 );                                                                                  \
      part2;                                                                                                           \
    }                                                                                                                  \
    sm[2].t += 256;                                                                                                    \
    sm[5].t += 256;                                                                                                    \
    ...
    {                                                                                                                  \
      part1( 3 );                                                                                                      \
      upd0( 1, 3, 0, 0, 0, 3, 2, 0 );                                                                                  \
      part2;                                                                                                           \
    }                                                                                                                  \
    {                                                                                                                  \
      part1( 2 );                                                                                                      \
      upd0( 1, 3, 0, 0, 2, 3, 1, 1 );                                                                                  \
      part2;                                                                                                           \
    }                                                                                                                  \
    {                                                                                                                  \
      part1( 1 );                                                                                                      \
      upd0( 1, 3, 0, 0, 2, 3, 0, 2 );                                                                                  \
      part2;                                                                                                           \
    }                                                                                                                  \
    sm[0].t -= 256;                                                                                                    \
    sm[1].t -= 256;                                                                                                    \
...
#  define eight_bits( part1, part2 )                                                                                   \
    ...
    {                                                                                                                  \
      part1( 7 );                                                                                                      \
      upd0( 1, 0, 0, 2, 0, 1, 6, 0 );                                                                                  \
      part2;                                                                                                           \
    }                                                                                                                  \
    sm[5].t += 256;                                                                                                    \
    {                                                                                                                  \
      part1( 6 );                                                                                                      \
      upd0( 3, 0, 0, 2, 0, 1, 5, 1 );                                                                                  \
      part2;                                                                                                           \
    }                                                                                                                  \
    if( method == TEXT )                                                                                               \
      sm[4].t += 256;                                                                                                  \
    ...
    {                                                                                                                  \
      part1( 3 );                                                                                                      \
      upd0( 3, 0, 3, 2, 0, 1, 2, 0 );                                                                                  \
      part2;                                                                                                           \
    }                                                                                                                  \
    sm[3].t += 256;                                                                                                    \
    {                                                                                                                  \
      part1( 2 );                                                                                                      \
      upd0( 3, 0, 3, 2, 0, 1, 1, 1 );                                                                                  \
      part2;                                                                                                           \
    }                                                                                                                  \
    {                                                                                                                  \
      part1( 1 );                                                                                                      \
      upd0( 3, 0, 3, 1, 0, 1, 0, 2 );                                                                                  \
      part2;                                                                                                           \
    }                                                                                                                  \
    sm[0].t -= 512;                                                                                                    \
    sm[1].t -= 256;                                                                                                    \
...
Encoder::Encoder( Mode m, FILE *f ) :
  ...
  for( i = 0; i < 1024; ++i )
#ifdef WIKI
    dt[i] = 512 * 35 / ( i + i + 8 ), dta[i] = 8192 / ( i + i + 8 );
#else
...
int main( int argc, char **argv ) {
  ...
  if( argc != 4 || !isdigit( argv[1][0] ) && argv[1][0] != 'd' ) {
    printf( "lpaq6 file compressor (C) 2007, Matt Mahoney\n"
            ...
            "\n"
            "To compress:   lpaq6 N input output  (N=0..9, uses 6+3*2^N MB)\n"
            "To decompress: lpaq6 d input output  (needs same memory)\n" );
    return 1;
  }
...
#  ifndef WIKI
        if( method == TEXT )
          if( ( pos == 9 * 512 * 1024 && DP_SHIFT == 16 ) || ( pos == 1024 * 1024 && DP_SHIFT == 15 )
              || DP_SHIFT == 14 )
#  else
        if( ( pos == 13 * 512 * 1024 && DP_SHIFT == 16 ) || ( pos == 1280 * 1024 && DP_SHIFT == 15 ) || DP_SHIFT == 14 )
#  endif
  ...
  // Decompress
    ...
    if( getc( in ) != 'p' || getc( in ) != 'Q' || getc( in ) != 6 )
      quit( "Not a lpaq6 file" );
    MEM = getc( in );
    if( MEM < '0' || MEM > '9' )
