...
152,154,156,158,194,146,148,150,152,154,156,158,160,162,164,166,168,170,172,174,
144,146,148,150,152,154,156,158,160,162,164,166,168,170,172,174,160,162,164,166,
168,170,172,174,176,178,180,182,184,186,188,190,196,188,198,172,200,188,202,172,
204,184,206,168,208,184,210,168,212,184,214,168,216,184,218,168,220,184,222,168,
224,184,226,168,228,184,230,168,232,184,234,168,236,184,238,168,240,184,242,168,
244,184,246,168,248,184,250,168,252,184,254,168,252,184,254,168,
...
153,155,157,159,145,147,149,151,153,155,157,159,161,163,165,167,169,171,173,175,
145,147,149,151,153,155,157,159,161,163,165,167,169,171,173,195,161,163,165,167,
169,171,173,175,177,179,181,183,185,187,189,193,131,197,147,199,131,201,147,203,
135,205,151,207,135,209,151,211,135,213,151,215,135,217,151,219,135,221,151,223,
135,225,151,227,135,229,151,231,135,233,151,235,135,237,151,239,135,241,151,243,
135,245,151,247,135,249,151,251,135,253,151,255,135,253,151,255,
};
...
#define eight_bits(part1,part2) \
    sm[0].t+=256;\
    { part1(7); upd0(3,3,1,0,0,0, 6,0); part2; }\
    { part1(6); upd0(1,3,1,0,0,0, 5,1); part2; }\
    sm[1].t+=256;\
    { part1(5); upd0(1,3,1,0,0,0, 4,2); part2; }\
    sm[2].t+=256;\
    sm[5].t+=256;\
    { part1(4); upd3(1,3,1,0,0,0, 3  ); part2; }\
    sm[4].t+=256;\
    { part1(3); upd0(1,3,0,0,0,3, 2,0); part2; }\
    { part1(2); upd0(1,3,0,0,2,3, 1,1); part2; }\
    { part1(1); upd0(1,3,0,0,2,3, 0,2); part2; }\
    sm[0].t-=256;\
    sm[1].t-=256;\
    sm[2].t-=256;\
    sm[4].t-=256;\
    sm[5].t-=256;\
    { part1(0); upd7(1,3,0,0,2,3     ); part2; }
#else
#define eight_bits(part1,part2) \
    sm[4].t+=256;\
    sm[0].t+=256;\
    { part1(7); upd0(1,0,0,2,0,1, 6,0); part2; }\
    sm[5].t+=256;\
    { part1(6); upd0(3,0,0,2,0,1, 5,1); part2; }\
    if (method==TEXT) sm[4].t+=256;\
    sm[2].t+=256;\
    { part1(5); upd0(3,0,0,2,0,3, 4,2); part2; }\
    sm[5].t+=256;\
    sm[1].t+=256;\
    { part1(4); upd3(3,0,3,2,0,3, 3  ); part2; }\
    sm[0].t+=256;\
    { part1(3); upd0(3,0,3,2,0,1, 2,0); part2; }\
    sm[3].t+=256;\
    { part1(2); upd0(3,0,3,2,0,1, 1,1); part2; }\
    { part1(1); upd0(3,0,3,1,0,1, 0,2); part2; }\
    sm[0].t-=512;\
    sm[1].t-=256;\
    sm[2].t-=256;\
    sm[3].t-=256;\
    ...
    sm[5].t-=512;\
    { part1(0); upd7(3,0,3,1,0,1     ); part2; }
#endif
...
int main(int argc, char **argv) {
  ...
  if (argc!=4 || !isdigit(argv[1][0]) && argv[1][0]!='d') {
    printf(
	"lpaq6 file compressor (C) 2007, Matt Mahoney\n"
  ...
  if (isdigit(argv[1][0])) {
    ...
    fprintf(out, "pQ%c%c%c%c%c%c%c", 6, argv[1][0],
