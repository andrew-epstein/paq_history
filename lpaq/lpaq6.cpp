...
static const U8 State_table[512 * 4] = {
    ...
    136, 138, 140, 142, 144, 146, 148, 150, 152, 154, 156, 158, 194, 130, 132, 134, 136, 138, 140, 142, 160, 162,
    164, 166, 168, 170, 172, 174, 144, 146, 148, 150, 152, 154, 156, 158, 176, 178, 180, 182, 184, 186, 188, 174,
    160, 162, 164, 166, 168, 170, 172, 174, 176, 178, 180, 182, 184, 186, 188, 190, 196, 188, 198, 172, 200, 188,
    202, 172, 204, 188, 206, 172, 208, 188, 210, 172, 212, 188, 214, 172, 216, 188, 218, 172, 220, 188, 222, 172,
    224, 188, 226, 172, 228, 188, 230, 172, 232, 188, 234, 172, 236, 188, 238, 172, 240, 188, 242, 172, 244, 188,
    246, 172, 248, 188, 250, 172, 252, 188, 254, 172, 252, 188, 254, 172,
    ...
    137, 139, 141, 143, 145, 147, 149, 151, 153, 155, 157, 159, 145, 131, 133, 135, 137, 139, 141, 143, 161, 163,
    165, 167, 169, 171, 173, 175, 145, 147, 149, 151, 153, 155, 157, 159, 177, 179, 181, 183, 185, 187, 189, 195,
    161, 163, 165, 167, 169, 171, 173, 175, 177, 179, 181, 183, 185, 187, 189, 193, 131, 197, 147, 199, 131, 201,
    147, 203, 131, 205, 147, 207, 131, 209, 147, 211, 131, 213, 147, 215, 131, 217, 147, 219, 131, 221, 147, 223,
    131, 225, 147, 227, 131, 229, 147, 231, 131, 233, 147, 235, 131, 237, 147, 239, 131, 241, 147, 243, 131, 245,
    147, 247, 131, 249, 147, 251, 131, 253, 147, 255, 131, 253, 147, 255,
};
...
#  define eight_bits( part1, part2 )                                                                                   \
    ...
    {                                                                                                                  \
      part1( 3 );                                                                                                      \
      upd0( 1, 3, 0, 0, 0, 1, 2, 0 );                                                                                  \
      p = Predictor_upd( y );                                                                                          \
    }                                                                                                                  \
    part2;                                                                                                             \
    {                                                                                                                  \
      part1( 2 );                                                                                                      \
      upd0( 1, 3, 0, 0, 2, 1, 1, 1 );                                                                                  \
      p = Predictor_upd( y );                                                                                          \
    }                                                                                                                  \
    part2;                                                                                                             \
    {                                                                                                                  \
      part1( 1 );                                                                                                      \
      upd0( 1, 3, 0, 0, 2, 1, 0, 2 );                                                                                  \
      p = Predictor_upd( y );                                                                                          \
    }                                                                                                                  \
    part2;                                                                                                             \
    sm[0].t -= 256;                                                                                                    \
...
#  define eight_bits( part1, part2 )                                                                                   \
    ...
    {                                                                                                                  \
      part1( 3 );                                                                                                      \
      upd0( 1, 0, 3, 2, 0, 3, 2, 0 );                                                                                  \
      p = Predictor_upd( y );                                                                                          \
    }                                                                                                                  \
    part2;                                                                                                             \
    {                                                                                                                  \
      part1( 2 );                                                                                                      \
      upd0( 1, 0, 3, 2, 0, 3, 1, 1 );                                                                                  \
      p = Predictor_upd( y );                                                                                          \
    }                                                                                                                  \
    part2;                                                                                                             \
    {                                                                                                                  \
      part1( 1 );                                                                                                      \
      upd0( 1, 0, 3, 2, 0, 3, 0, 2 );                                                                                  \
      p = Predictor_upd( y );                                                                                          \
    }                                                                                                                  \
    part2;                                                                                                             \
    sm[0].t -= 256;                                                                                                    \
...
Encoder::Encoder( Mode m, FILE *f ) :
  ...
  for( i = 0; i < 1024; ++i )
#ifdef WIKI
    dt[i] = 18432 / ( i + i + 8 ), dta[i] = 8192 / ( i + i + 6 );
#else
    dt[i] = 9216 / ( i + i + 3 ), dta[i] = ( 10240 + 1536 ) / ( i + i + 8 );
    ...
    { // this is because we don't save TextFlag in the compressed file
      ...
      if( k == 0 ) {
        for( s = 0, TextFlag = 1; s < ss; ++s )
          if( file_buf[s] == 0x1f || file_buf[s] == 0x20 )
            file_buf[s] ^= 0x3f;
      } else if( file_buf[0] == 'M' && file_buf[1] == 'Z' )
        ExeFlag = 1;
      fb_pos = p;
